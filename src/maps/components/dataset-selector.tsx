...
const availableDataSets: IDataSetInfo[] = [
  ...
  {name: "NEO Precipitation", filename: "neo-precip.json", description: "NEO Monthly Total Precipitation for US: June 2022 - February 2024", observationName: "Precipitation", gridSize: 0.5, centerLatLng: [39.833333, -98.585522], zoomLevel: 4, units: "mm"},
]
